...
zypper -c ${zypp_config} --installroot=${target} --releasever=/ \
    ...
    SLE-Module-Basesystem15-Debuginfo-Pool SLE-Module-Basesystem15-Debuginfo-Updates.repo SLE-Module-Basesystem15-Pool SLE-Module-Basesystem15-Source-Pool SLE-Module-Basesystem15-Updates SLE-Module-Containers15-Debuginfo-Pool SLE-Module-Containers15-Debuginfo-Updates SLE-Module-Containers15-Pool SLE-Module-Containers15-Source-Pool SLE-Module-Containers15-Updates SLE-Module-Desktop-Applications15-Debuginfo-Pool SLE-Module-Desktop-Applications15-Debuginfo-Updates SLE-Module-Desktop-Applications15-Pool \
